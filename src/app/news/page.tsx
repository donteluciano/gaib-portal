      ...
      <div className="min-h-screen" style={{ backgroundColor: 'var(--navy)', color: 'var(--cream)' }}>
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
              ...
              <Link href="/news" style={{ color: 'var(--gold)', fontWeight: 400, fontSize: '11px', letterSpacing: '2px', textTransform: 'uppercase', textDecoration: 'none' }}>News</Link>
        ...
        <section className="pt-40 pb-20 px-10 text-center">
          ...
          <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(36px, 5vw, 56px)', fontWeight: 300, letterSpacing: '6px', textTransform: 'uppercase', marginBottom: '20px' }}>
            <span style={{ color: 'var(--gold)' }}>News</span> & Insights
          </h1>
          <p className="text-sm tracking-[3px] uppercase" style={{ color: 'var(--text-muted)' }}>Market Commentary & Firm Updates</p>
        </section>
        ...
        <section className="py-20 px-10 max-w-4xl mx-auto">
          ...
          <div className="mb-16 p-10" style={{ background: 'var(--navy-light)', border: '1px solid rgba(184, 150, 90, 0.15)' }}>
            <div className="text-[11px] tracking-[3px] uppercase mb-4" style={{ color: 'var(--gold)' }}>April 2026 • Firm Update</div>
            <h2 className="text-2xl mb-4" style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 400 }}>
              Herald Capital Partners Launches New Website
            </h2>
            <p className="text-sm leading-relaxed mb-6" style={{ color: 'var(--text-muted)' }}>
              We are pleased to announce the launch of our new firm website. Herald Capital Partners continues to focus on private infrastructure and real estate investments in special situations, pursuing opportunities where our expertise creates meaningful value for our limited partners.
            </p>
            <p className="text-sm" style={{ color: 'var(--text-muted)' }}>
              For inquiries regarding investment opportunities or partnership discussions, please contact us through our website.
            </p>
          </div>

          {/* Coming Soon */}
          <div className="text-center py-16">
            <div className="w-[30px] h-px mx-auto mb-6" style={{ background: 'var(--gold)' }} />
            <p className="text-sm tracking-[2px] uppercase mb-4" style={{ color: 'var(--gold)' }}>More Updates Coming Soon</p>
            <p className="text-sm max-w-md mx-auto" style={{ color: 'var(--text-muted)' }}>
              Stay tuned for market insights, investment commentary, and firm announcements. Subscribe to our updates or check back regularly.
            </p>
          </div>
